...
class TheLastStandGame(bs.CoopGameActivity):
    ...
    def __init__(self,settings={}):
        ...
        if settings['preset'] == 'default': settings['map'] = 'Rampage'
        elif settings['preset'] == 'jrmp': settings['map'] = 'Rampage'
        ...
        elif self._preset == 'jrmp':
            self._botSpawnTypes = self._botSpawnTypes = {bs.BomberBot:[1.0,  0.0,  0.0],
                                bs.WizardBot:[0.7,  0.0,  0.0],
                                bs.WizardBotPro:[0.0, 0.05, 0.002],
                                bs.CyborgBot:[0.2, 0.00, 0.0],
                                bs.CyborgBotPro:[0.02, 0.04, 0.005],
                                bs.BomberBotPro:[0.0,  0.05, 0.001],
                                bs.BomberBotProShielded:[0.0,  0.02, 0.002],
                                bs.ToughGuyBot:[1.0,  0.0,  0.0],
                                bs.ToughGuyBotPro:[0.0,  0.05, 0.001],
                                ...
                                bs.NinjaBot:[0.3,  0.05, 0.0],
                                bs.MelBot:[0.1,  0.03, 0.001],
                                bs.MelDuperBot:[0.001,  0.04, 0.002],
                                bs.PirateBot:[0.05, 0.02, 0.002],
                                bs.PirateBotRadius:[0.01, 0.03, 0.002],
                                bs.SpyBot:[0.2, 0.01, 0.002],
                                bs.SpyBotPro:[0.25, 0.048, 0.2],
                                bs.AgentBot:[0.05, 0.02, 0.002],
                                bs.AgentBotShielded:[0.02, 0.04, 0.005],
                                bs.LooieBot:[0.07, 0.03, 0.004],
                                bs.LooieBotShielded:[0.04, 0.02, 0.002],
                                bs.FrostyBot:[0.02, 0.04, 0.001],
                                bs.FrostyBotShielded:[0.01, 0.01, 0.004],
                                bs.AliBot:[0.05, 0.04, 0.002],
                                bs.AliBotPro:[0.02, 0.02, 0.0019],
                                bs.SoldierBot:[0.0, 0.005, 0.03],
                                bs.BunnyBot:[0.04, 0.04, 0.006],
                                bs.SantaBot:[0.16, 0.25, 0.088],
                                bs.KlayBot:[0.1, 0.24, 0.26],
                                bs.KnightBot:[0.0, 0.07, 0.047],
                                bs.KnightBotPro:[0.002, 0.333, 0.219],
                                bs.PascalBot:[0.05, 0.0, 0.001],
                                bs.JuiceBot:[0.03, 0.03, 0.03],
                                bs.PixelBot:[0.02,  0.03, 0.01],
                                bs.PixelBotPro:[0.0,  0.01, 0.003],
                                bs.BearBot:[0.0,  0.05, 0.005],
                                bs.BearBotShielded:[0.006,  0.03, 0.01],
                                bs.ZillBot:[0.239, 0.2, 0.1],
                                bs.CowBot:[0.04,  0.02, 0.004],
                                bs.CowBotShielded:[0.01,  0.01, 0.002],
                                bs.DiceBot:[0.01,  0.08, 0.23],
                                bs.RonnieBot:[0.02,  0.0, 0.004],
                                bs.BonesBot:[0.05, 0.04, 0.001]
                                }


    def onTransitionIn(self):
        if self._preset == 'default': self.music = 'Epic'
        elif self._preset == 'jrmp': self.music = 'Last Stand'
        bs.CoopGameActivity.onTransitionIn(self,music=self.music)
    ...
    def _startBotUpdates(self):
        if self._preset == 'jrmp': self._delay = 5000
        else: self._delay = 3000
        self._botUpdateInterval = self._delay - 300*(len(self.players))
        self._updateBots()
        self._updateBots()
